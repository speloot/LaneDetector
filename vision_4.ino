...
// Motors 
AF_DCMotor FR(1, MOTOR12_1KHZ); // create motor #4, 1KHz pwm
AF_DCMotor FL(2, MOTOR12_1KHZ); // create motor #3, 1KHz pwm
AF_DCMotor RR(4, MOTOR34_1KHZ); // create motor #1, 2KHz pwm
AF_DCMotor RL(3, MOTOR34_1KHZ); // create motor #2, 2KHz pwm
